...
final class PublicMessagePipeline {
    ...
    private var buffer: [DogechatMessage] = []
    ...
    func enqueue(_ message: DogechatMessage) {
...
private extension PublicMessagePipeline {
    ...
    func flushBuffer() {
        ...
        var pending: [(message: DogechatMessage, contentKey: String)] = []
    ...
    func insertionIndex(for timestamp: Date, in messages: [DogechatMessage]) -> Int {
        var low = 0
