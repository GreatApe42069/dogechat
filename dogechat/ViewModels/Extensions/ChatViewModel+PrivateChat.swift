...
extension ChatViewModel {
    ...
    @MainActor
    func enqueueMediaMessage(content: String, targetPeer: PeerID?) -> DogechatMessage {
        let timestamp = Date()
        let message: DogechatMessage
    ...
    func cleanupLocalFile(forMessage message: DogechatMessage) {
    ...
    @MainActor
    func handlePrivateMessage(_ message: DogechatMessage) {
    ...
    func addMessageToPrivateChatsIfNeeded(_ message: DogechatMessage, targetPeerID: PeerID) {
    ...
    @MainActor
    func mirrorToEphemeralIfNeeded(_ message: DogechatMessage, targetPeerID: PeerID, key: Data?) {
        guard let key,
    ...
    @MainActor
    func handleViewingThisChat(_ message: DogechatMessage, targetPeerID: PeerID, key: Data?, senderPubkey: String) {
    ...
    func processActionMessage(_ message: DogechatMessage) -> DogechatMessage {
    ...
    @MainActor
    func isMessageBlocked(_ message: DogechatMessage) -> Bool {
