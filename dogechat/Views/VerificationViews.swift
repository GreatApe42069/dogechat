    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(Strings.pastePrompt)
                .font(.dogechatSystem(size: 14, weight: .medium, design: .monospaced))
...
struct VerificationSheetView: View {
    ...
    private var accentColor: Color { Color.adaptiveGreen(isDark: colorScheme == .dark) }
    private var boxColor: Color { Color.gray.opacity(0.1) }
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    Image(systemName: "xmark")
                        .font(.dogechatSystem(size: 14, weight: .semibold))
                        .foregroundColor(accentColor)
                }
                .buttonStyle(.plain)
            }
                ...
                if showingScanner {
                    ...
                    Button(action: { showingScanner = true }) {
                        Label("scan someone else's qr", systemImage: "camera.viewfinder")
                            .font(.dogechatSystem(size: 13, weight: .medium, design: .monospaced))
                    }
                    .buttonStyle(.bordered)
                    .tint(.gray)
                }
