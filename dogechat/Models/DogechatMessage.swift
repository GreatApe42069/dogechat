...
final class DogechatMessage: Codable {
    let id: String
    let sender: String
    let content: String
    let timestamp: Date
...
extension DogechatMessage: Equatable {
    static func == (lhs: DogechatMessage, rhs: DogechatMessage) -> Bool {
...
extension Array where Element == DogechatMessage {
