...
final class MessageFormattingEngine {
    ...
    private static func formatSystemMessage(_ message: DogechatMessage, isDark: Bool) -> AttributedString {
        var result = AttributedString()
    ...
    private static func formatMatch(_ text: String, type: MatchType, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        case .mention:
            ...
            mentionStyle.foregroundColor = .mentionColor  // Lime green color (#32CD32) for mentions
        ...
        case .url:
            ...
            style.font = .dogechatSystem(size: 14, design: .monospaced)
    ...
    private static func formatTimestamp(_ timestamp: String) -> AttributedString {
        ...
        style.font = .dogechatSystem(size: 10, design: .monospaced)
