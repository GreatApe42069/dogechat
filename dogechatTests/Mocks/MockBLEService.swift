...
final class MockBLEService: NSObject {
    ...
    var sentMessages: [(message: DogechatMessage, packet: DogechatPacket)] = []
    var sentPackets: [DogechatPacket] = []
    var connectedPeers: Set<PeerID> = []
    var messageDeliveryHandler: ((DogechatMessage) -> Void)?
    var packetDeliveryHandler: ((DogechatPacket) -> Void)?
    ...
    func simulateIncomingMessage(_ message: DogechatMessage) {
    ...
    func simulateIncomingPacket(_ packet: DogechatPacket) {
